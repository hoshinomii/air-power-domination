...
namespace GameNet.KriptoFX.Realistic_Effects_Pack_3.Effects.ImageEffects.Scripts
{
    [ExecuteInEditMode]
    ...
    public class Bloom : PostEffectsBase
    {
        ...
        public void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            if (hdr == HDRBloomMode.Auto)
                doHdr = source.format == RenderTextureFormat.ARGBHalf && GetComponent<UnityEngine.Camera>().allowHDR;
            else {
