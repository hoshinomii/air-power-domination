using GameNet.KriptoFX.Realistic_Effects_Pack_3.Effects.ImageEffects.Scripts;
using UnityEditor;
using UnityEngine;

namespace GameNet.KriptoFX.Realistic_Effects_Pack_3.Editor.ImageEffects
{
    ...
    class BloomEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            UnityEngine.Camera cam = (target as Bloom).GetComponent<UnityEngine.Camera>();
            if (cam != null) {
